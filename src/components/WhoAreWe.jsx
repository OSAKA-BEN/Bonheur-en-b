  ...
  return (
    ...
    <div className="py-20 md:py-40 flex flex-col gap-10 items-center relative content mx-4">
      <div className="relative flex items-center justify-center">
        <p className={`font-bold poppins-font absolute text-[60px] md:text-[120px] lg:text-[160px] xl:text-[250px] mx-auto z-[0] pointer-events-none ${darkMode ? 'font-stroke-dark' : 'font-stroke-light'}`} data-aos="fade-up" data-aos-delay="200">BonheurenB</p>
          ...
          {gitesImg.map((gite) => (
            <div key={gite.id} className="relative flex-grow flex flex-col mb-2 items-center justify-center">
              ...
              <div className="absolute uppercase text-xl bottom-0 right-0 pr-2 bg-[#0c0d0c] px-4 py-2 rounded-tl-xl">
                {gite.name}
                <div className="social-icon text-center ml-2">
