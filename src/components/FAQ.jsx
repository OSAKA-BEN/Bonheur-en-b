      ...
      <div className="flex flex-wrap -mx-4 -mb-32">
        <div className="relative w-full md:w-1/2 lg:w-1/3 px-4 mb-32">
          ...
          <div className="w-full">
            <h3 className="mb-6 text-2xl text-black dark:text-white font-heading">Accessibilité</h3>
        ...
        <div className="relative w-full md:w-1/2 lg:w-1/3 px-4 mb-32">
          ...
          <div className="w-full">
            <h3 className="mb-6 text-2xl text-black dark:text-white font-heading">Heures d&#39;arrivée et de départ</h3>
            <span className="text-gray-500">
        ...
        <div className="relative w-full md:w-1/2 lg:w-1/3 px-4 mb-32">
          <div className="w-64 mx-auto flex justify-center items-center">
            <span className="relative block mb-6">
              <svg className="dark:stroke-[#FFEC3E] dark:fill-[#FFEC3E]" width="48" height="48" viewBox="0 0 32 33" xmlns="http://www.w3.org/2000/svg" fill="#000">
          ...
          <div className="w-full">
            <h3 className="mb-6 text-2xl text-black dark:text-white font-heading">Remise des clés</h3>
            <span className="text-gray-500">
        ...
        <div className="relative w-full md:w-1/2 lg:w-1/3 px-4 mb-32">
          ...
          <div className="w-full">
            <h3 className="mb-6 text-2xl text-black dark:text-white font-heading">Courses</h3>
            <span className="text-gray-500">
        ...
        <div className="relative w-full md:w-1/2 lg:w-1/3 px-4 mb-32">
          ...
          <div className="w-full">
            <h3 className="mb-6 text-2xl text-black dark:text-white font-heading">Dépôt de garantie</h3>
            <span className="text-gray-500">
        ...
        <div className="relative w-full md:w-1/2 lg:w-1/3 px-4 mb-32">
          <div className="w-64 mx-auto flex justify-center items-center">
            <span className="relative block mb-6">
            <svg className="dark:stroke-[#FFEC3E] dark:fill-[#FFEC3E]" width="48" height="48" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 550 400" fill="#000" stroke="#000">
              <g>
          ...
          <div className="w-full">
            <h3 className="mb-6 text-2xl text-black dark:text-white font-heading">Chiens</h3>
            <span className="text-gray-500">
        ...
        <div className="relative w-full md:w-1/2 lg:w-1/3 px-4 mb-32">
          ...
          <div className="w-full">
            <h3 className="mb-6 text-2xl text-black dark:text-white font-heading">Tabac</h3>
            <span className="text-gray-500">
        ...
        <div className="relative w-full md:w-1/2 lg:w-1/3 px-4 mb-32">
          ...
          <div className="w-full">
            <h3 className="mb-6 text-2xl text-black dark:text-white font-heading">Taxe de séjour</h3>
        ...
        <div className="relative w-full md:w-1/2 lg:w-1/3 px-4 mb-32">
          ...
          <div className="w-full">
            <h3 className="mb-6 text-2xl text-black dark:text-white font-heading">Parking</h3>
            <span className="text-gray-500">
