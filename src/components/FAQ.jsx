...
const FAQ = () => {
  ...
  <div className="py-40 flex flex-col gap-10 items-center relative content mx-12">
      <div className="relative flex items-center justify-center">
        <p className={`font-bold absolute text-[280px] mx-auto z-[0] pointer-events-none ${darkMode ? 'font-stroke-dark' : 'font-stroke-light'}`} data-aos="fade-up" data-aos-delay="200">FAQ</p>
        <h2 className={`dancing-font text-6xl font-bold z-[1] ${darkMode ? 'text-white' : 'text-black'}`} data-aos="fade-up" data-aos-delay="300">Nous répondons à vos questions</h2>
      </div>
      ...
      <button 
      className="flex mb-8 p-8 group w-full items-center justify-between rounded-3xl border border-black dark:border-white text-left"
      onClick={() => setOpenFAQ(openFAQ === 'accessibility' ? null : 'accessibility')}>
        <div className="max-w-xl pr-5">
          <div className="flex items-start mb-6"> {/* Conteneur Flex pour l'icône et le titre */}
            <h3 className="text-2xl font-semibold text-black dark:text-white">Accessibilité</h3>
          </div>
          <p className={`mt-3 text-lg text-gray-500 ${openFAQ === 'accessibility' ? 'block' : 'hidden'}`}>
        ...
        <span className={`${openFAQ === 'accessibility' ? 'block' : 'hidden'}`}>
            <svg className="dark:stroke-[#ec4899]" width="48" height="48" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ec4899">
      ...
      onClick={() => setOpenFAQ(openFAQ === 'hours' ? null : 'hours')}>
        <div className="max-w-xl pr-5">
          ...
          <p className={`mt-3 text-lg text-gray-500 ${openFAQ === 'hours' ? 'block' : 'hidden'}`}>
      ...
      onClick={() => setOpenFAQ(openFAQ === 'keys' ? null : 'keys')}>
        <div className="max-w-xl pr-5">
          <div className="flex items-start mb-6"> {/* Conteneur Flex pour l'icône et le titre */}
            <h3 className="text-2xl font-semibold text-black dark:text-white">Remise des clés</h3>
          </div>
          <p className={`mt-3 text-lg text-gray-500 ${openFAQ === 'keys' ? 'block' : 'hidden'}`}>
        ...
        <span className={`${openFAQ === 'keys' ? 'block' : 'hidden'}`}>
          <svg className="dark:stroke-[#ec4899] dark:fill-[#ec4899]" width="48" height="48" viewBox="0 0 32 33" xmlns="http://www.w3.org/2000/svg" fill="#ec4899">
      ...
      onClick={() => setOpenFAQ(openFAQ === 'courses' ? null : 'courses')}>
        <div className="max-w-xl pr-5">
          ...
          <p className={`mt-3 text-lg text-gray-500 ${openFAQ === 'courses' ? 'block' : 'hidden'}`}>
      ...
      onClick={() => setOpenFAQ(openFAQ === 'guarantee' ? null : 'guarantee')}>
        <div className="max-w-xl pr-5">
          <div className="flex items-start mb-6"> {/* Conteneur Flex pour l'icône et le titre */}
            <h3 className="text-2xl font-semibold text-black dark:text-white">Dépôt de garantie</h3>
          </div>
          <p className={`mt-3 text-lg text-gray-500 ${openFAQ === 'guarantee' ? 'block' : 'hidden'}`}>
      ...
      onClick={() => setOpenFAQ(openFAQ === 'dogs' ? null : 'dogs')}>
        <div className="max-w-xl pr-5">
          <div className="flex items-start mb-6"> {/* Conteneur Flex pour l'icône et le titre */}
            <h3 className="text-2xl font-semibold text-black dark:text-white">Chiens</h3>
          </div>
          <p className={`mt-3 text-lg text-gray-500 ${openFAQ === 'dogs' ? 'block' : 'hidden'}`}>
        ...
        <span className={`${openFAQ === 'dogs' ? 'block' : 'hidden'}`}>
          <svg className="dark:stroke-[#ec4899] dark:fill-[#ec4899]" width="48" height="48" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 550 400" fill="#ec4899" stroke="#ec4899">
            <g>
      ...
      onClick={() => setOpenFAQ(openFAQ === 'tabac' ? null : 'tabac')}>
        <div className="max-w-xl pr-5">
          <div className="flex items-start mb-6"> {/* Conteneur Flex pour l'icône et le titre */}
            <h3 className="text-2xl font-semibold text-black dark:text-white">Tabac</h3>
          </div>
          <p className={`mt-3 text-lg text-gray-500 ${openFAQ === 'tabac' ? 'block' : 'hidden'}`}>
      ...
      onClick={() => setOpenFAQ(openFAQ === 'parking' ? null : 'parking')}>
        <div className="max-w-xl pr-5">
          ...
          <p className={`mt-3 text-lg text-gray-500 ${openFAQ === 'parking' ? 'block' : 'hidden'}`}>
      ...
      onClick={() => setOpenFAQ(openFAQ === 'tax' ? null : 'tax')}>
        <div className="max-w-xl pr-5">
          <div className="flex items-start mb-6"> {/* Conteneur Flex pour l'icône et le titre */}
            <h3 className="text-2xl font-semibold text-black dark:text-white">Taxe de séjour</h3>
          </div>
          <div className={`mt-3 text-lg text-gray-500 ${openFAQ === 'tax' ? 'block' : 'hidden'}`}>
