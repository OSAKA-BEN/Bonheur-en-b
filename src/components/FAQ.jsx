...
const FAQ = () => {
  ...
  return (
  <section id="faq" className="relative z-0 pb-20 overflow-hidden bg-no-repeat bg-center bg-cover bg-fixed" style={{ backgroundImage: "url('src/assets/background-papierpeintblack.jpg')" }}>  
  <div className="py-40 flex flex-col gap-10 items-center relative content mx-12">
      <div className="relative flex items-center justify-center">
        <p className={`font-bold poppins-font absolute text-[280px] mx-auto z-[0] pointer-events-none ${darkMode ? 'font-stroke-dark' : 'font-stroke-light'}`} data-aos="fade-up" data-aos-delay="200">FAQ</p>
