...
return (
  <section id="footer" className="bg-slate-200 dark:bg-[#0c0d0c] overflow-x-hidden relative">
    <div className="border-t py-12">
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">

      <div className="social-icon text-center">
        <a className={darkMode ? " border border-[#EFE7D2]" : "text-black border border-black"} href="https://www.facebook.com/groups/470717321340382/" target="_blank" rel="noopener noreferrer">
        ...
        <a className={darkMode ? " border border-[#EFE7D2]" : "text-black border border-black"} href="https://www.linkedin.com/in/guy-catteau-35604493/?originalSubdomain=fr">
          <svg className="icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <p className="mt-4 text-center  text-sm md:text-lg">Copyright © Les Bonheur en B 2023</p>
      </div>
