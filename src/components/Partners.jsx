    ...
    <section id="partners" className="bg-slate-200 dark:bg-[#0c0d0c]">
      <div className="py-20 md:py-40 flex flex-col gap-10 items-center relative content mx-12">
        <div className="relative flex items-center justify-center">
          <p className={`font-bold absolute poppins-font text-[60px] md:text-[180px] lg:text-[250px] mx-auto z-[0] pointer-events-none ${darkMode ? 'font-stroke-dark' : 'font-stroke-light'}`} data-aos="fade-up" data-aos-delay="200">Partenaires</p>
        </div>
